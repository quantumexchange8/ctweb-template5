    ...
    <article id="center_column" class=" grid_5">
      <div class="toolbar">
        ...
        <div class="lg-panel htabs">
          <label>View</label>
          <a href="/productList" class="list-btn first-bg " id="list"></a> <a class="grid-btn  first-bg active " id="grid" href="/productGrid"></a> </div>
      </div>
      <ul class="products-grid">
        <li class="item first fadeIn animated"> <a rel="prettyPhoto[pp_gal]" class="fa-search-btn first-bg"  href="media/246-thickbox_default.jpg"> enlarge image <i class="icon-search"></i></a> <a class="product-image" title="Product Name" href="/productDetails"> <img src="media/home-default.png" width="249" height="180" alt="product"></a>
          <h2 class="product-name"> <a title="Product Name" href="/productDetails"> Product Name </a> </h2>
          <div class="actions"> <a class="btn-circle first-bg-hover"> <i class="icon-heart"></i> </a> <a class="btn-circle first-bg-hover"> <i class="icon-shopping-cart"></i> </a> <a class="btn-circle first-bg-hover"> <i class="icon-exchange"></i> </a> </div>
             ...
             <li class="item  fadeIn animated"> <a rel="prettyPhoto[pp_gal]" class="fa-search-btn first-bg"  href="media/246-thickbox_default.jpg"> enlarge image <i class="icon-search"></i></a> <a class="product-image" title="Product Name" href="/productDetails"> <img src="media/home-default2.png" width="249" height="180" alt="product"></a>
          <h2 class="product-name"> <a title="Product Name" href="/productDetails"> Product Name </a> </h2>
          <div class="actions"> <a class="btn-circle first-bg-hover"> <i class="icon-heart"></i> </a> <a class="btn-circle first-bg-hover"> <i class="icon-shopping-cart"></i> </a> <a class="btn-circle first-bg-hover"> <i class="icon-exchange"></i> </a> </div>
        </li>
              <li class="item last fadeIn animated"> <a rel="prettyPhoto[pp_gal]" class="fa-search-btn first-bg"  href="media/246-thickbox_default.jpg"> enlarge image <i class="icon-search"></i></a> <a class="product-image" title="Product Name" href="/productDetails"> <img src="media/home-default3.png" width="249" height="180" alt="product"></a>
          <h2 class="product-name"> <a title="Product Name" href="/productDetails"> Product Name </a> </h2>
          <div class="actions"> <a class="btn-circle first-bg-hover"> <i class="icon-heart"></i> </a> <a class="btn-circle first-bg-hover"> <i class="icon-shopping-cart"></i> </a> <a class="btn-circle first-bg-hover"> <i class="icon-exchange"></i> </a> </div>
        </li>
      </ul>
