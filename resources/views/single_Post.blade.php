      ...
      <ul class="post-list post-view">
        <li>
          ...
          <div class="post-details">
            <table>
              <tr>
                <td><i class="icon-comment"></i> 13 comments</td>
                <td><i class="icon-time"></i>Dec 31, 2012</td>
              </tr>
            </table>
          </div>
            ...
            <ul class="comment-list">
              <li>
                <div class="comment-wrap">
                  <div class="user-ico first-bg"><img src="media/comment-icon1.jpg" width="70" height="67"></div>
                  <div class="content-comment">
                    <h3 class="comment-name">Collis Ta'eed <span class="time-ago">47 minutes ago</span></h3>
                    <div class="comment">Testing the comments</div>
                    <a href="#" class="reply"> reply</a> </div>
                </div>
                <ul >
                  <li>
                    <div class="comment-wrap">
                      <div class="user-ico first-bg"><img src="media/comment-icon2.jpg" width="70" height="67"></div>
                      <div class="content-comment">
                        <h3 class="comment-name">Collis Ta'eed <span class="time-ago">47 minutes ago</span></h3>
                        <div class="comment">Testing the comments</div>
                        <a href="#" class="reply"> reply</a> </div>
                    ...
                    <ul >
                      <li>
                        <div class="comment-wrap">
                          <div class="user-ico first-bg"><img src="media/comment-icon3.jpg" width="70" height="67"></div>
                          <div class="content-comment">
                            <h3 class="comment-name">Collis Ta'eed <span class="time-ago">47 minutes ago</span></h3>
                            <div class="comment">Testing the comments</div>
                            <a href="#" class="reply"> reply</a> </div>
          ...
          <form class="form-add-comment">
            ...
            <div class="btn-set">
              <button type="submit" class="button"><span><span>Add a Comment</span></span></button>
            </div>
          </form>
        </li>
      </ul>
